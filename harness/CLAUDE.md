# AI Development Harness — Project Instructions
...
| Archivo                        | Permiso     |
|-------------------------------|-------------|
| `harness/current-dev.xml`     | Lectura y escritura |
| `harness/story-dev.xml`       | Solo escritura (append) |
| `harness/agents/*.md`         | Solo lectura |
